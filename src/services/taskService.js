...
function getFirestoreErrorMessage(error) {
  if (!error || typeof error !== "object") {
    return "Une erreur est survenue lors de la gestion des taches. Veuillez reessayer.";
  }

  return error.message || "Une erreur est survenue lors de la gestion des taches. Veuillez reessayer.";
}
